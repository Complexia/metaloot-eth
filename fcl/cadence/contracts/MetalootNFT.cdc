...
access(all) contract MetaLootNFT: NonFungibleToken {
    ...
    access(all) resource NFT: NonFungibleToken.NFT {
        ...
        access(all) fun createEmptyCollection(): @{NonFungibleToken.Collection} {
            return <-MetaLootNFT.createEmptyCollection(nftType: Type<@MetaLootNFT.NFT>())
        }
        ...
        access(all) fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetaLootNFT.resolveContractView(resourceType: Type<@MetaLootNFT.NFT>(), viewType: Type<MetadataViews.NFTCollectionData>())
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return MetaLootNFT.resolveContractView(resourceType: Type<@MetaLootNFT.NFT>(), viewType: Type<MetadataViews.NFTCollectionDisplay>())
                ...
                case Type<MetadataViews.EVMBridgedMetadata>():
                    ...
                    let contractLevel = MetaLootNFT.resolveContractView(
                            resourceType: nil,
    ...
    access(all) resource interface MetaLootNFTCollectionPublic {}

    access(all) resource Collection: NonFungibleToken.Collection, MetaLootNFTCollectionPublic {
   ...
   access(all) var ownedNFTs: @{UInt64: {NonFungibleToken.NFT}}
        ...
        access(all) view fun getSupportedNFTTypes(): {Type: Bool} {
            ...
            supportedTypes[Type<@MetaLootNFT.NFT>()] = true
        ...
        access(all) view fun isSupportedNFTType(type: Type): Bool {
            return type == Type<@MetaLootNFT.NFT>()
        }

        /// withdraw removes an NFT from the collection and moves it to the caller
        access(NonFungibleToken.Withdraw) fun withdraw(withdrawID: UInt64): @{NonFungibleToken.NFT} {
            let token <- self.ownedNFTs.remove(key: withdrawID)
                ?? panic("MetaLootNFT.Collection.withdraw: Could not withdraw an NFT with ID "
        ...
        access(all) fun deposit(token: @{NonFungibleToken.NFT}) {
            let token <- token as! @MetaLootNFT.NFT
            let id = token.id
            ...
            MetaLootNFT.emitNFTUpdated(authTokenRef)
        }
        ...
        switch viewType {
            case Type<MetadataViews.NFTCollectionData>():
                let collectionData = MetadataViews.NFTCollectionData(
                    ...
                    publicCollection: Type<&MetaLootNFT.Collection>(),
                    publicLinkedType: Type<&MetaLootNFT.Collection>(),
    ...
    access(all) resource NFTMinter {
        ...
        access(all) fun mintNFT(
            ...
            MetaLootNFT.totalSupply = MetaLootNFT.totalSupply + 1
    ...
    self.totalSupply = 0 
        ...
        let collectionCap = self.account.capabilities.storage.issue<&MetaLootNFT.Collection>(self.CollectionStoragePath)
